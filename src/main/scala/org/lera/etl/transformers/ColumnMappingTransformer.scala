...
object ColumnMappingTransformer extends BaseTransformer{
  ...
  override def transform(
    ...
    val mappingConfigDataFrame : DataFrame = 
      configHandler(dataFrameSeq.keys)(getDefaultTableConfigFunc(columnMappingConfigT))
  ...
  private def getColumnMappingConfig(tableConf : TableConfig, configDataFrame : DataFrame): Array[(String,String)] = {
